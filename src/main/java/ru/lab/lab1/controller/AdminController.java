...
public class AdminController {
    ...
    public ResponseEntity<?> getMovieInfo(@RequestParam(name = "id") Long id) {
        ...
        if (movie == null) {
            return new ResponseEntity<>(MessageRespDTO.builder().message("Фильм не найден").build(), HttpStatus.OK);
        }
    ...
    public ResponseEntity<?> saveMovie(@RequestBody SaveMovieReqDTO saveMovieReqDTO) {
